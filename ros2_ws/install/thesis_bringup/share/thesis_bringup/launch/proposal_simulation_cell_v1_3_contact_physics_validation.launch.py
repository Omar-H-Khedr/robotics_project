...
def launch_setup(context, *args, **kwargs):
    ...
    config_path = PathJoinSubstitution(
        [
            ...
            "config",
            "proposal_simulation_cell_v1_3.yaml",
        ]
    )
    ...
    clock_bridge = Node(
        ...
        name="proposal_simulation_cell_v1_3_gz_bridge",
        output="screen",
        arguments=[
    ...
    image_bridge = Node(
        ...
        name="proposal_simulation_cell_v1_3_image_bridge",
        output="screen",
        arguments=[
    ...
    validator = Node(
        ...
        executable="proposal_simulation_cell_v1_3_contact_validator",
        name="proposal_simulation_cell_v1_3_contact_validator",
        output="screen",
        parameters=[
    ...
    return [
        ...
        LogInfo(
            msg=(
                "proposal_simulation_cell_v1_3_contact_physics_validation: validating "
                "contact-rich simulation foundations only. No MoveIt, /compute_ik, "
        ...
        RegisterEventHandler(
            OnProcessExit(
                ...
                on_exit=[EmitEvent(event=Shutdown(reason="v1.3 contact physics evidence captured"))],
            )
        ),
    ]
...
def generate_launch_description():
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                "output_dir",
                default_value="diagnostics/proposal_simulation_cell_v1_3",
                description="Directory for proposal simulation cell v1.3 diagnostics.",
            ),
