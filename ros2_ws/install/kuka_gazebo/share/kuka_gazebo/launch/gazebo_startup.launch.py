...
def launch_setup(context, *args, **kwargs):
    ...
    initial_joint_1 = LaunchConfiguration("initial_joint_1")
    initial_joint_2 = LaunchConfiguration("initial_joint_2")
    initial_joint_3 = LaunchConfiguration("initial_joint_3")
    initial_joint_4 = LaunchConfiguration("initial_joint_4")
    initial_joint_5 = LaunchConfiguration("initial_joint_5")
    initial_joint_6 = LaunchConfiguration("initial_joint_6")
...
def generate_launch_description():
    launch_args = [
        ...
        DeclareLaunchArgument("initial_joint_1", default_value="0.0"),
        DeclareLaunchArgument("initial_joint_2", default_value="-0.8"),
        DeclareLaunchArgument("initial_joint_3", default_value="1.2"),
        DeclareLaunchArgument("initial_joint_4", default_value="0.0"),
        DeclareLaunchArgument("initial_joint_5", default_value="0.8"),
        DeclareLaunchArgument("initial_joint_6", default_value="0.0"),
