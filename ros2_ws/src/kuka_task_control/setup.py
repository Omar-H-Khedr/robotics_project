...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "move_group_diagnostic_config_builder = kuka_task_control.move_group_diagnostic_config_builder:main",
            "move_group_runtime_audit = kuka_task_control.move_group_runtime_audit:main",
