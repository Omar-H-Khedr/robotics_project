...
def launch_setup(context, *args, **kwargs):
    ...
    config_path = PathJoinSubstitution(
        [FindPackageShare("thesis_bringup"), "config", "proposal_simulation_cell_v2_14.yaml"]
    )
    ...
    bridge = Node(
        ...
        name="proposal_simulation_cell_v2_14_gz_bridge",
        output="screen",
    ...
    contact_bridge = Node(
        package="ros_gz_bridge",
        executable="parameter_bridge",
        name="proposal_simulation_cell_v2_14_contact_bridge",
        output="screen",
        arguments=[
            "/world/proposal_simulation_cell_v1_3_contact_physics_validation/model/"
            "proposal_v2_14_context_conditioned_contact_pad/link/contact_calibration_pad_link/"
    ...
    robot_state_publisher = Node(
        ...
        name="proposal_simulation_cell_v2_14_robot_state_publisher",
        output="screen",
    ...
    spawn_robot = Node(
        package="ros_gz_sim",
        executable="create",
        name="proposal_simulation_cell_v2_14_spawn_robot",
        output="screen",
        arguments=[
            "-topic",
            "robot_description",
            "-name",
            "lbr_iisy3_r760_v2_14_context_conditioned_action",
            "-allow_renaming",
            "-x",
            "0",
            "-y",
    ...
    joint_state_broadcaster = Node(
        ...
        executable="spawner",
        name="proposal_simulation_cell_v2_14_joint_state_broadcaster_spawner",
        output="screen",
    ...
    joint_trajectory_controller = Node(
        package="controller_manager",
        executable="spawner",
        name="proposal_simulation_cell_v2_14_joint_trajectory_controller_spawner",
        output="screen",
    ...
    task_sequence = Node(
        ...
        executable="proposal_simulation_cell_v2_14_context_conditioned_action_node",
        name="proposal_simulation_cell_v2_14_context_conditioned_action_node",
        output="screen",
    ...
    return [
        ...
        LogInfo(
            msg=(
                ...
                "deterministic v2.13 context embeddings produce guarded action suggestions for five "
                "Gazebo-only contact-gate scenarios through the verified joint_trajectory_controller. "
                "No policy training, RL training, fake result, real robot, physical endpoint, peg "
        ...
        RegisterEventHandler(
            OnProcessExit(
                ...
                on_exit=[EmitEvent(event=Shutdown(reason="v2.14 context-conditioned guarded action validation captured"))],
            )
        ),
    ]
...
def generate_launch_description():
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                "output_dir",
                default_value="diagnostics/proposal_simulation_cell_v2_14",
                description="Directory for proposal simulation cell v2.14 diagnostics.",
            ),
