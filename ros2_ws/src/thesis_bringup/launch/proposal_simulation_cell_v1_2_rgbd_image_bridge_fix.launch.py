...
def launch_setup(context, *args, **kwargs):
    ...
    world_path = os.path.join(
        peg_share,
        "worlds",
        "proposal_simulation_cell_v1_2_rgbd_image_bridge_fix.world.sdf",
    )
    ...
    config_path = PathJoinSubstitution(
        [
            ...
            "config",
            "proposal_simulation_cell_v1_2.yaml",
        ]
    )
    ...
    clock_bridge = Node(
        ...
        name="proposal_simulation_cell_v1_2_gz_bridge",
        output="screen",
        arguments=[
    ...
    image_bridge = Node(
        ...
        name="proposal_simulation_cell_v1_2_image_bridge",
        output="screen",
        arguments=[
    ...
    validator = Node(
        ...
        executable="proposal_simulation_cell_v1_2_rgbd_validator",
        name="proposal_simulation_cell_v1_2_rgbd_validator",
        output="screen",
        parameters=[
    ...
    return [
        ...
        LogInfo(
            msg=(
                "proposal_simulation_cell_v1_2_rgbd_image_bridge_fix: validating "
                "Gazebo RGB and depth image samples only. No MoveIt, /compute_ik, "
                "real robot, controller execution, or FollowJointTrajectory is used."
            )
        ),
        gazebo,
        clock_bridge,
        ...
        RegisterEventHandler(
            OnProcessExit(
                ...
                on_exit=[EmitEvent(event=Shutdown(reason="v1.2 RGB-D evidence captured"))],
            )
        ),
    ]
...
def generate_launch_description():
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                "output_dir",
                default_value="diagnostics/proposal_simulation_cell_v1_2",
                description="Directory for proposal simulation cell v1.2 diagnostics.",
            ),
