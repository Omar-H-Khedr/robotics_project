...
def launch_setup(context, *args, **kwargs):
    ...
    config_path = PathJoinSubstitution(
        [FindPackageShare("thesis_bringup"), "config", "proposal_simulation_cell_v2_5.yaml"]
    )
    ...
    bridge = Node(
        ...
        name="proposal_simulation_cell_v2_5_gz_bridge",
        output="screen",
    ...
    robot_state_publisher = Node(
        ...
        name="proposal_simulation_cell_v2_5_robot_state_publisher",
        output="screen",
    ...
    spawn_robot = Node(
        package="ros_gz_sim",
        executable="create",
        name="proposal_simulation_cell_v2_5_spawn_robot",
        output="screen",
        arguments=[
            "-topic",
            "robot_description",
            "-name",
            "lbr_iisy3_r760_v2_5_guarded_task",
            "-allow_renaming",
            "-x",
            "0",
            "-y",
    ...
    joint_state_broadcaster = Node(
        ...
        executable="spawner",
        name="proposal_simulation_cell_v2_5_joint_state_broadcaster_spawner",
        output="screen",
    ...
    joint_trajectory_controller = Node(
        package="controller_manager",
        executable="spawner",
        name="proposal_simulation_cell_v2_5_joint_trajectory_controller_spawner",
        output="screen",
    ...
    task_sequence = Node(
        ...
        executable="proposal_simulation_cell_v2_5_guarded_task_sequence_node",
        name="proposal_simulation_cell_v2_5_guarded_task_sequence_node",
        output="screen",
    ...
    return [
        ...
        LogInfo(
            msg=(
                ...
                "guarded MoveIt planning and Gazebo-only execution through the verified "
        ...
        RegisterEventHandler(
            OnProcessExit(
                ...
                on_exit=[EmitEvent(event=Shutdown(reason="v2.5 guarded pre-contact sequence captured"))],
            )
        ),
    ]
...
def generate_launch_description():
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                "output_dir",
                default_value="diagnostics/proposal_simulation_cell_v2_5",
                description="Directory for proposal simulation cell v2.5 diagnostics.",
            ),
