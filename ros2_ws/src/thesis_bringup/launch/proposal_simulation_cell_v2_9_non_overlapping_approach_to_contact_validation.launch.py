...
def launch_setup(context, *args, **kwargs):
    ...
    config_path = PathJoinSubstitution(
        [FindPackageShare("thesis_bringup"), "config", "proposal_simulation_cell_v2_9.yaml"]
    )
    ...
    bridge = Node(
        ...
        name="proposal_simulation_cell_v2_9_gz_bridge",
        output="screen",
    ...
    contact_bridge = Node(
        package="ros_gz_bridge",
        executable="parameter_bridge",
        name="proposal_simulation_cell_v2_9_contact_bridge",
        output="screen",
        arguments=[
            "/world/proposal_simulation_cell_v1_3_contact_physics_validation/model/"
            "proposal_v2_9_non_overlapping_contact_pad/link/contact_calibration_pad_link/"
    ...
    robot_state_publisher = Node(
        ...
        name="proposal_simulation_cell_v2_9_robot_state_publisher",
        output="screen",
    ...
    spawn_robot = Node(
        package="ros_gz_sim",
        executable="create",
        name="proposal_simulation_cell_v2_9_spawn_robot",
        output="screen",
        arguments=[
            "-topic",
            "robot_description",
            "-name",
            "lbr_iisy3_r760_v2_9_non_overlapping_contact",
            "-allow_renaming",
            "-x",
            "0",
            "-y",
    ...
    joint_state_broadcaster = Node(
        ...
        executable="spawner",
        name="proposal_simulation_cell_v2_9_joint_state_broadcaster_spawner",
        output="screen",
    ...
    joint_trajectory_controller = Node(
        package="controller_manager",
        executable="spawner",
        name="proposal_simulation_cell_v2_9_joint_trajectory_controller_spawner",
        output="screen",
    ...
    task_sequence = Node(
        ...
        executable="proposal_simulation_cell_v2_9_non_overlapping_contact_node",
        name="proposal_simulation_cell_v2_9_non_overlapping_contact_node",
        output="screen",
    ...
    return [
        ...
        LogInfo(
            msg=(
                ...
                "positive-clearance standby, raw contact topic wiring, and bounded Gazebo-only "
                "approach-to-contact through the verified joint_trajectory_controller. No real robot, "
        ...
        RegisterEventHandler(
            OnProcessExit(
                ...
                on_exit=[EmitEvent(event=Shutdown(reason="v2.9 non-overlapping approach-to-contact validation captured"))],
            )
        ),
    ]
...
def generate_launch_description():
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                "output_dir",
                default_value="diagnostics/proposal_simulation_cell_v2_9",
                description="Directory for proposal simulation cell v2.9 diagnostics.",
            ),
