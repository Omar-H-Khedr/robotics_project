...
def launch_setup(context, *args, **kwargs):
    ...
    config_path = PathJoinSubstitution(
        [FindPackageShare("thesis_bringup"), "config", "proposal_simulation_cell_v2_11.yaml"]
    )
    ...
    bridge = Node(
        ...
        name="proposal_simulation_cell_v2_11_gz_bridge",
        output="screen",
        arguments=[
    ...
    image_bridge = Node(
        ...
        name="proposal_simulation_cell_v2_11_image_bridge",
        output="screen",
        arguments=[
    ...
    contact_bridge = Node(
        package="ros_gz_bridge",
        executable="parameter_bridge",
        name="proposal_simulation_cell_v2_11_contact_bridge",
        output="screen",
        arguments=[
            "/world/proposal_simulation_cell_v1_3_contact_physics_validation/model/"
            "proposal_v2_11_multimodal_contact_pad/link/contact_calibration_pad_link/"
    ...
    robot_state_publisher = Node(
        ...
        name="proposal_simulation_cell_v2_11_robot_state_publisher",
        output="screen",
    ...
    spawn_robot = Node(
        package="ros_gz_sim",
        executable="create",
        name="proposal_simulation_cell_v2_11_spawn_robot",
        output="screen",
        arguments=[
            "-topic",
            "robot_description",
            "-name",
            "lbr_iisy3_r760_v2_11_multimodal_contact",
            "-allow_renaming",
            "-x",
            "0",
            "-y",
    ...
    joint_state_broadcaster = Node(
        ...
        executable="spawner",
        name="proposal_simulation_cell_v2_11_joint_state_broadcaster_spawner",
        output="screen",
    ...
    joint_trajectory_controller = Node(
        package="controller_manager",
        executable="spawner",
        name="proposal_simulation_cell_v2_11_joint_trajectory_controller_spawner",
        output="screen",
    ...
    task_sequence = Node(
        ...
        executable="proposal_simulation_cell_v2_11_multimodal_observation_logger_node",
        name="proposal_simulation_cell_v2_11_multimodal_observation_logger_node",
        output="screen",
    ...
    return [
        ...
        LogInfo(
            msg=(
                ...
                "five positive-clearance contact-gate scenarios with synchronized observation logging "
                "through the verified Gazebo joint_trajectory_controller. No real robot, physical endpoint, "
                "peg insertion, forceful contact, fake dataset, or fake result."
            )
        ),
        gazebo,
        bridge,
        ...
        RegisterEventHandler(
            OnProcessExit(
                ...
                on_exit=[EmitEvent(event=Shutdown(reason="v2.11 multimodal contact observation logging captured"))],
            )
        ),
    ]
...
def generate_launch_description():
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                "output_dir",
                default_value="diagnostics/proposal_simulation_cell_v2_11",
                description="Directory for proposal simulation cell v2.11 diagnostics.",
            ),
