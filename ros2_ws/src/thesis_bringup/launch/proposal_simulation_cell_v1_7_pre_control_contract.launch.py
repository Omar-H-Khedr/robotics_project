...
def launch_setup(context, *args, **kwargs):
    ...
    clock_bridge = Node(
        ...
        name="proposal_simulation_cell_v1_7_gz_bridge",
        output="screen",
        arguments=[
    ...
    image_bridge = Node(
        ...
        name="proposal_simulation_cell_v1_7_image_bridge",
        output="screen",
        arguments=[
    ...
    upstream_safety_interface = Node(
        ...
        parameters=[
            ...
            {"output_dir": "diagnostics/proposal_simulation_cell_v1_7/upstream_v1_5"},
    ...
    upstream_readiness_gate = Node(
        ...
        parameters=[
            ...
            {"output_dir": "diagnostics/proposal_simulation_cell_v1_7/upstream_v1_6"},
            {"isaac_available": isaac_available},
            {"gazebo_fallback_used": gazebo_fallback_used},
            {"ros_gz_bridge_available": ros_gz_bridge_available},
    ...
    return [
        ...
        LogInfo(
            msg=(
                "proposal_simulation_cell_v1_7_pre_control_contract: simulation-only "
                "pre-control contract validation. Command outputs and motion execution are disabled; "
                "no MoveIt, /compute_ik, controllers, real robot, FollowJointTrajectory, or trajectory execution is used."
            )
        ),
        gazebo,
        clock_bridge,
        ...
        pre_control_contract,
        RegisterEventHandler(
            OnProcessExit(
                target_action=pre_control_contract,
                on_exit=[EmitEvent(event=Shutdown(reason="v1.7 pre-control contract captured"))],
            )
        ),
    ]
...
def generate_launch_description():
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                "output_dir",
                default_value="diagnostics/proposal_simulation_cell_v1_7",
                description="Directory for proposal simulation cell v1.7 diagnostics.",
            ),
